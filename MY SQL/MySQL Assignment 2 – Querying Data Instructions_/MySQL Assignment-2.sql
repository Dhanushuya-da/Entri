...
SELECT * FROM employees WHERE Designation = NULL ;
...
SELECT * FROM EMPLOYEES ORDER BY  HIRE_DATE = 2018 LIMIT 5;
...
from employees Group By Department_id Having Employee_Count <3 ;
...
SELECT l.location_id, l.location_name, AVG(e.age) AS Avg_Female_Age
FROM employees e
...
ORDER BY l.location_id, e.employee_name;